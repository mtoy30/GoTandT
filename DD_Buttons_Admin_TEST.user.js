...
function createDropdownMenu(claimant, claim, referralDate, headerTitle) {
    ...
    const fullOptions = [
        ...
        "JBS Request for Higher Rates (Default Rates)",
        "Wait time request",
    ...
    if (headerTitle.startsWith("212-")) {
        exclusions = ["Standard Rate Request", "CareIQ Rate Request", "JBS Request for Higher Rates (Default Rates)", "CareWorks Rate Request"];
        ...
        exclusions = ["Standard Rate Request", "Homelink Rate Request", "JBS Request for Higher Rates (Default Rates)", "CareWorks Rate Request"];
    } else {
        exclusions = ["CareIQ Rate Request", "JBS Request for Higher Rates (Default Rates)", "CareWorks Rate Request", "Homelink Rate Request"];
    }
...
function selectCorrectRadioButton(selectedOption) {
    ...
    } else if (selectedOption === "JBS Request for Higher Rates (Default Rates)") {
